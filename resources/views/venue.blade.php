    ...
    <div class="site-blocks-cover overlay" style="background-image: url({{ $venue->getFirstMediaUrl('main_photo') }});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    <span class="d-inline-block text-white px-3 mb-3 property-offer-type rounded">房產明細</span>
            ...
            <div class="row">
                    ...
                    <div class="bg-white">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                                <span class="d-inline-block text-black mb-0 caption-text">活動類型</span>
                                <strong class="d-block">{{ implode(', ', $venue->event_types->pluck('name')->toArray()) }}</strong>
                            </div>
                            <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                                <span class="d-inline-block text-black mb-0 caption-text">地段</span>
                                <strong class="d-block">{{ $venue->location->name }}</strong>
                            </div>
                            <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                                <span class="d-inline-block text-black mb-0 caption-text">人數</span>
                                <strong class="d-block">{{ $venue->people_minimum }} - {{ $venue->people_maximum }}</strong>
                            </div>
                        </div>
                        <h2 class="h4 text-black">更多資訊</h2>
                        <p>{{ $venue->description }}</p>

                        <div class="row mt-5">
                            <div class="col-12">
                                <h2 class="h4 text-black mb-3">房產活動花絮</h2>
                            </div>
                ...
                <div class="col-lg-4 pl-md-5">
                    ...
                    <div class="bg-white widget border rounded">
                        ...
                        <h3 class="h4 text-black widget-title mb-3">聯絡業務</h3>
                    ...
                    <div class="bg-white widget border rounded">
                        <h3 class="h4 text-black widget-title mb-3">為保護你的權益</h3>
                        <p>若你的需求非業務/產品諮詢方面，請直接撥打 24 小時客服專線：02-8751-6665。</p>
                    </div>
